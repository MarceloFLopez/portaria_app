...
public class TabPessoaDAO implements Serializable {
	...
	public List<TabPessoa> ListAll() {
		try {
			return (List<TabPessoa>) em.createNamedQuery("TabPessoa.listAll").getResultList();
	...
	public TabPessoa findColumnName(String value) {
		try {
			return (TabPessoa) em.createNamedQuery("TabPessoa.findColumName").setParameter("name", value)
					.getSingleResult();
		} catch (NoResultException e) {
			e.getStackTrace();
			return null;
	...
	public TabPessoa findColumnCpf(String value) {
		try {
			return (TabPessoa) em.createNamedQuery("TabPessoa.findColumnCpf").setParameter("cpf", value)
					.getSingleResult();
		} catch (NoResultException e) {
			e.getStackTrace();
			return null;
